    ...
    return (
        <div style={{
          ...
          <div className="z-10 w-full lg:w-10/12 xl:max-w-7xl mx-auto ">
            ...
            <Link to={'/services'} className="px-4 sm:px-6 py-2.5 sm:py-3 mt-4 inline-block bg-green-500 hover:bg-green-400 text-white font-semibold shadow-md transition duration-300 text-sm sm:text-base">
                {t('hero.cta')}
            </Link>
            </div>
          </div>
