...
//       icon: PiUsersThreeBold,
//       path: "customerspage",
//       matchPaths: ["customerspage", "report-analysis", "customers/", "order/"],
//     },
//     {
//       id: "orders",
//       label: t("sidebar.employee.orders"),
...
//     // Priority 1: activeMenu from navigation state
//     if (location.state?.activeMenu) {
//       setActiveMenu(location.state.activeMenu);
//       return;
//     }

//     // Priority 2: Check if on customer detail pages
//     if (pathname.includes("/customers/") || pathname.includes("/order/")) {
//       setActiveMenu("customer");
//       return;
//     }

//     // Priority 3: Normal route matching
//     if (pathname === "/employee" || pathname === "/employee/") {
//       setActiveMenu("dashboard");
//       return;
//     }

//     // Priority 4: Check other routes
//     let foundActiveMenu = "";
