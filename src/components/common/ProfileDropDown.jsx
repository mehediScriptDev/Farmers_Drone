    ...
    <nav className="bg-white shadow-sm sticky top-0 z-50 px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="max-w-7xl mx-auto xl:h-20 flex items-center justify-center">
        <div className="flex justify-between items-center w-full h-16">
          ...
          {/* Mobile Menu Button & Menu Container */}
          <div ref={containerRef} className="lg:hidden flex items-center space-x-2 relative">
            <LanguageSwitcher />
            <button
              onClick={() => setIsOpen(!isOpen)}
              className="text-gray-700 hover:text-green-500 transition-colors duration-200 z-50"
            >
            ...
            {/* Mobile Menu */}
            {isOpen && (
              <div className="absolute top-16 left-0 w-full bg-white border-t border-gray-200 z-40">
