    ...
    <div className="flex-1 p-4 md:px-12 ">
      ...
      <div className="flex gap-2 md:gap-3 mb-2 md:mb-4">
        <button onClick={() => setIsPaymentModalOpen(true)}
          className="px-3 md:px-6 py-2 md:py-2 bg-[#28A844] text-white rounded-lg hover:bg-green-600 font-medium text-xs md:text-sm lg:text-base flex items-center">
        ...
        <button onClick={() => setIsDiscountModalOpen(true)}
          className="px-3 md:px-6 py-2 md:py-2 bg-[#FFC107] text-white rounded-lg hover:bg-yellow-500 font-medium text-xs md:text-sm lg:text-base flex items-center">
