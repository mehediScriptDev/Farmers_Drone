...
// import { IoChevronDown } from "react-icons/io5"; // Importing IoChevronDown for the new select style
...
// // Select component
// // NOTE: Keeping the original Select component as it's used elsewhere (PersonalInfoModal, VerificationModal)
// const Select = memo(
...
//   // Removed dropdownOpen state as we are using a standard select now
...
//   // Updated handler for standard select onChange
...
//           {/* START: Replaced Custom Dropdown with Styled Select */}
//           <div>
//             <label className="block text-base font-medium text-[#002244] mb-2">
//               {t("dashboard.employee.modal.setupType")}
//               <span className='text-red-500'>*</span> {/* Adding required asterisk based on logic */}
//             </label>
...
//                 // Styling to match the requested component and existing design
...
//               >
//                 <option value=''>
//                   {t('dashboard.employee.modal.personalInformation')}
//                 </option>
...
//             )}
//           </div>
//           {/* END: Replaced Custom Dropdown with Styled Select */}
...
//             />
//             {/* Note: Corrected Inputx to Input to match existing component definition */}
//             <Input
//               label="Last Name"
//               name="lastName"
