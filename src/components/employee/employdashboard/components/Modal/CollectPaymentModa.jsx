  ...
  return (
    <>
      <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-5 z-50">
        <div
          ref={modalRef}
          className="bg-white rounded-lg w-full max-w-xl shadow-2xl p-3 sm:p-4 mx-2"
        >
          {/* Header */}
          ...
          <div className="p-3 sm:p-4">
            ...
            <div className="mb-3">
              ...
              <input
                ...
                className="w-full px-2 sm:px-3 py-2 sm:py-2.5 border border-gray-300 rounded focus:outline-none focus:border-green-500 text-base"
              />
            </div>
                ...
                <div className="absolute top-full left-0 right-0 bg-white border border-gray-300 rounded mt-1 shadow-lg z-10 overflow-hidden">
                  {paymentMethods.map((method, index) => (
                    <div
                      ...
                      className={`px-2 sm:px-3 py-2 sm:py-2.5 cursor-pointer text-base transition-colors ${
            ...
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-2.5 sm:py-3 rounded text-base transition-colors"
            >
