      ...
      <div className='w-full px-4 sm:px-6 lg:px-8 py-6'>
        ...
        <div className='bg-white rounded-xl shadow-sm p-6'>
          ...
          <p className='text-gray-600 mb-6'>
            This page will contain social media management functionality.
          </p>

          {/* Demo Content */}
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            <div className='bg-gray-50 p-4 rounded-lg'>
              <h3 className='font-semibold text-gray-900 mb-2'>Total Reach</h3>
              <p className='text-2xl font-bold text-blue-600'>89.1k</p>
            </div>
            <div className='bg-gray-50 p-4 rounded-lg'>
            ...
            <div className='bg-gray-50 p-4 rounded-lg'>
              <h3 className='font-semibold text-gray-900 mb-2'>Posts Today</h3>
