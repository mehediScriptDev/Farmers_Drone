...
const SeasonalCampaignDetails = () => {
  ...
  const stats = [
    { label: "Impressions", value: "245,000", icon: FiEye, trend: "+12%" },
    { label: "Clicks", value: "12,300", icon: FiMousePointer, trend: "+8%" },
    { label: "Lead Genetation", value: "387", icon: FiUsers, trend: "+15%" },
    { label: "Conversions Rate", value: "387", icon: FiUsers, trend: "+15%" },
    {
      label: "RIO",
      value: "3.15%",
      icon: FiTrendingUp,
