...
export default function ImformatinSection({ formData, setFormData }) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            <div className="bg-white/70 backdrop-blur-lg rounded-2xl  w-full max-w-4xl p-8">
                {/* Header */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col relative">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 pr-12 py-2 rounded-xl border border-gray-300 bg-white/60 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-green-400"
                            />
                    ...
                    <div className="flex flex-col sm:col-span-2 relative" ref={dropdownRef}>
                        ...
                        <div
                            ...
                            className="flex items-center justify-between px-4 py-3 rounded-xl cursor-pointer border border-gray-300 bg-white/60 backdrop-blur-sm shadow-md hover:shadow-lg w-full"
                        >
                            ...
                            <div className="absolute top-full left-0 z-10 mt-1 w-full bg-white border border-gray-300 rounded-xl shadow-lg max-h-60 overflow-y-auto">
                                {industries.map((ind) => (
                                    <div
                                        ...
                                        className={`px-4 py-3 cursor-pointer transition hover:bg-green-50 ${formData.industry === ind
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {subCategories.map((cat) => (
                                <div
                                    ...
                                    className={`flex items-center justify-between px-4 py-2 rounded-xl cursor-pointer transition shadow-md hover:shadow-lg ${formData.subCategories.includes(cat.id)
